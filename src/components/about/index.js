    ...
    <section className="py-40" id="about">
      <Container>
        <div className="flex gap-10">
          ...
          >
            <Image src="/viral.jpg" sizes="100vw" fill objectFit="cover" alt="cover" />
          </div>
          <div className="w-auto flex flex-col">
            ...
            <p className="font-normal text-base">
              I&apos;m a tech-savvy Full-Stack Developer skilled in React.js, DevOps,
              and team leadership. I handle everything from front-end to
              back-end, including infrastructure management. I&apos;m also proficient
              in React Native app development, taking projects from concept to
              reality. I specialize in crafting user-friendly websites and
              applications. My code is clean, optimized, and I stay updated with
              the latest industry tools and techniques. Collaboration is my
              strength; I thrive in cross-functional teams, leading projects
              from dynamic interfaces to end-to-end development and deployment.
